    ...
    <>
        ...
        <div className="ml-4">
            ...
            <div className="m-8 grid grid-cols-2 space-x-4">
                <div className="pr-20 mb-10 bg-gradient-to-b from-pink-200 to-pink-400 rounded-xl p-5">
                ...
                <div className="pr-20 mb-10 bg-gradient-to-b from-blue-200 to-blue-400 rounded-xl p-5">
                ...
                <div className="pr-20 mb-5 bg-gradient-to-b from-pink-200 to-pink-400 rounded-xl p-5">
            ...
            <div className="pr-20 m-10 p-8 bg-[#535252] text-white rounded-lg">
